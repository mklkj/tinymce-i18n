...
tinymce.addI18n('es_MX', {
    ...
    "You have unsaved changes are you sure you want to navigate away?": "No se han guardado los cambios. Estas seguro que desea abandonar la página?",
    "Restore last draft": "Restaurar último borrador",
    "Special character...": "Carácter especial...",
    "Special Character": "Caracteres especiales",
    "Source code": "Código de origen",
    "Insert/Edit code sample": "Insertar o editar ejemplo de código",
    "Language": "Idioma",
    ...
    "Help": "Ayuda",
    "Address": "Dirección",
    "Focus to menubar": "Centrarse en la barra de menú",
    ...
    "Save (if save plugin activated)": "Guardar (si guardar complemento está activado)",
    "Find (if searchreplace plugin activated)": "Buscar (si buscar y reemplazar complemento está activado)",
    ...
    "The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?": "La URL que ha introducido parece ser una dirección de correo electrónico. Desea agregar el prefijo requerido mailto:?",
    ...
    "Paste your embed code below:": "Pegar su código de inserción abajo",
    "Embed": "Inserción ",
    "Media...": "Elemento multimedia...",
    "Nonbreaking space": "Espacio sin separación",
    ...
    "Open popup menu for split buttons": "Abrir menú emergente para separar botones",
    "List Properties": "Propiedades de lista",
    "List properties...": "Propiedades de lista...",
    "Start list at number": "Iniciar lista con número",
