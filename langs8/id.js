tinymce.addI18n("id", {
    ...
    "Accordion": "Accordion",
    "Accordion body...": "Badan accordion...",
    "Accordion summary...": "Ringkasan accordion...",
    "Action": "Tindakan",
    "Activity": "Aktivitas",
    "Address": "Alamat",
    "Advanced": "Lanjutan",
    ...
    "Background color {0}": "Warna latar belakang {0}",
    "Black": "Hitam",
    "Block": "Blok",
    "Block {0}": "Blok {0}",
    "Blockquote": "Kutipan",
    ...
    "Browse links": "Jelajahi tautan",
    "Build with {0}": "Bangun dengan {0}",
    ...
    "Default": "Bawaan",
    "Delete accordion": "Hapus accordion",
    ...
    "Edit": "Sunting",
    "Editor's height: {0} pixels": "Tinggi editor: {0} piksel",
    "Editor's height: {0} pixels, Editor's width: {1} pixels": "Tinggi editor: {0} piksel, Lebar editor: {1} piksel",
    "Embed": "Semat",
    "Emojis": "Emoji",
    "Emojis...": "Emoji...",
    "Error": "Kesalahan",
    ...
    "Focus to notification": "Fokus pada notifikasi",
    ...
    "Hexadecimal only, 000000 to FFFFFF": "Hanya heksadesimal, 000000 hingga FFFFFF",
    "Hidden": "Sembunyi",
    ...
    "Insert accordion": "Masukkan accordion",
    ...
    "Insert date/time menu": "Menu sisipan tanggal/waktu",
    ...
    "Numbers only, 0 to 255": "Hanya angka, 0 hingga 255",
    "OR": "ATAU",
    "Objects": "Objek",
    "Ok": "Ok",
    ...
    "Select the {0} element": "Pilih elemen {0}",
    "Select...": "Pilih...",
    "Selection": "Pemilihan",
    "Shortcut": "Pintasan",
    ...
    "Toggle accordion": "Alih accordion",
    "Tools": "Alat",
    "Top": "Atas",
