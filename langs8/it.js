tinymce.addI18n("it", {
    ...
    "Height": "Altezza",
    "Help": "Guida",
    "Hex color code": "Codice esadecimale del colore",
    "Hidden": "Nascosto",
    ...
    "Inset": "Inserto",
    "Invalid hex color code: {0}": "Codice esadecimale del colore non valido: {0}",
    ...
    "Press the Up and Down arrow keys to resize the editor.": "Premi le frecce in su e in gi\xf9 per ridimensionare l'editor.",
    ...
    "The URL you entered seems to be an external link. Do you want to add the required https:// prefix?": "L'URL che hai inserito sembra essere un collegamento esterno. Vuoi aggiungere il prefisso https:// necessario?",
    "Title": "Titolo",
